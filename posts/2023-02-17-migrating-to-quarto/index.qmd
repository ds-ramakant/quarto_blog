...
![](quarto.jpg){style="fig-align: center;  float: right" width="40%"}
...
1.  Solving exercises in Introduction to Statistical Learning in R v2 (PDF)
2.  Solving exercises in "Hands-on Data Science for Marketing", Packt (Hwang) (Kindle edition)
3.  Marketing Analytics projects using R, Python
    -   Market Mix Modelling using Kaggle
    -   building plotly and shiny dashboards
4.  revise and blog about Quant research concepts from "Marketing Research", Pearson 7e (Malhotra/Dash)
5.  Target for daily check-ins all thru Feb
6.  If above is completed, then proceed to "Python ML: ML & Deep Learning with Python, sci-kit and TensorFlow 2", Packt (Raschka/Mirjalili) (PDF)
7.  Research & academic articles in the field of digital marketing/ marketing analytics??🤔
8.  Exploring discussions on using NLP in the field of qualitative research
