...
# accuracy is 0.7799 after:
#   a) new grouping technique
#   b) replacing NA age as per sex/pclass grouping
#   c) adding embarked

predicted <- bind_cols(test, dt_predict) %>% 
  rename(dt_yhat = .pred_class) 
write.csv(predicted, row.names = F,
          file = ".\\posts\\2023-03-06-day-14-of-50daysofkaggle\\predictions_debug.csv")
